...
public class MyApp {
	...
	public static void main(String[] args) {
		...
		Getopt g = new Getopt("MyApp", args, "K:p:s:c:d:b:y:h");
		...
		rsaPrivateKey.SetExponent1(exponent1);
		rsaPrivateKey.SetExponent2(exponent2);
		rsaPrivateKey.SetModulus(n);
		rsaPrivateKey.SetPrime1(p);
		rsaPrivateKey.SetPrime2(q);
		rsaPrivateKey.SetPublicExponent(eNext);
		rsaPrivateKey.SetPrivateExponent(d);
		rsaPrivateKey.SetCoefficient(coefficient);
		
		RSAPublicKey rsaPublicKey = new RSAPublicKey();
		rsaPublicKey.SetModulus(n);
		rsaPublicKey.SetPublicExponent(eNext);
